...
app.post(
  ...
  [
    body('title').isString().trim().isLength({ max: 100 }).withMessage('Başlık en fazla 100 karakter olmalı.'),
    body('description').isString().trim().isLength({ max: 1000 }).withMessage('Açıklama en fazla 1000 karakter olmalı.'),
